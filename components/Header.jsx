...
import { HiMenu, HiSearch, HiUserCircle, HiUsers } from 'react-icons/hi';
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10">
        ...
        <div className="flex items-center rounded-full p-2 md:border-2 md:shadow-sm">
            ...
            <HiSearch className="hidden md:inline-flex h-8 w-8 bg-red-400 text-white rounded-full p-2 cursor-pointer drop-shadow-sm mx-auto md:mx-1.5" />
        </div>
